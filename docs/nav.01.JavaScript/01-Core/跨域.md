...
1. <http://evil.com> 向 <http://mybank.com> 发起AJAX HTTP请求，请求会默认把<http://mybank.com> 对应cookie也同时发送过去。
...
跨域资源共享，详细可以看阮一峰老师的博客<http://www.ruanyifeng.com/blog/2016/04/cors.html>
...
解决对于主域名相同，子域名不同情况下的跨域请求问题，即<https://a.peterchen.club> 访问 <https://b.peterchen.club>的内容
